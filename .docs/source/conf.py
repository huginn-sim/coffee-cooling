# -*- coding: utf-8 -*-
#
# Hugenn - Coffee Cooling documentation build configuration file, created by
...
htmlhelp_basename = 'Hugenn-CoffeeCoolingdoc'
...
texinfo_documents = [
  ('index', 'Hugenn-CoffeeCooling', u'Hugenn - Coffee Cooling Documentation',
   u'Evin Özer & Cody Bomberger', 'Hugenn-CoffeeCooling', 'One line description of project.',
   'Miscellaneous'),
]
